WalletScribe is a simple Android app that reads your Google Wallet transaction notifications (and all other notifications just to test the app is working) and logs them into a Google Sheet.
